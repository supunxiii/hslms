...
// new import to connect to the API
import { registerDoctor } from "../../services/Apis";
...
const Doctor = () => {
  ...
  const submitUserData = async (e) => {
    ...
    if (fname === "") {
      ...
      const response = await registerDoctor(data, config);
          ...
          <div className="staff-add-container">
            ...
            <Card className="shadow mt-3 p-3">
              <div className="profile_div text-center">
                <img
                  src={preview ? preview : "/add-doctor.jpg"}
                  alt="hospital-staff"
                />
              </div>
